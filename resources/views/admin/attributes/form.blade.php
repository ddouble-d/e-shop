                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    '-- Set Type --', 'readonly' => $disableInput]) !!}
                                    @error('type')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('is_required', $booleanOptions , null, ['class' => 'form-control',
                                    'placeholder' => '']) !!}
                                    @error('is_required')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('is_unique', $booleanOptions , null, ['class' => 'form-control',
                                    'placeholder' => '']) !!}
                                    @error('is_unique')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('is_configurable', $booleanOptions , null, ['class' =>
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('is_filterable', $booleanOptions , null, ['class' =>
                                    'form-control', 'placeholder' => '']) !!}
                                    @error('is_filterable')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
